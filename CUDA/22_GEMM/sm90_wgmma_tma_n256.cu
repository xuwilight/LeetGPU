...
#pragma unroll
    ...
    stmatrix_copy(reg_c, shared_memory, 0);
    __syncthreads();
    store<bM, bN, T>(gC, shared_memory, N, 0);
}
...
/**
 * nvcc sm90_wgmma_tma_n256.cu -O3 -arch=sm_90a -lcuda -lcublas -o sm90_wgmma_tma_n256 && ./sm90_wgmma_tma_n256
 * cublas time = 0.187863 ms, TFLPOS = 731.591240, mfu = 0.739728
 * mma time = 0.194061 ms, TFLPOS = 708.223800, mfu = 0.716101
 */
int main()
{
    float u = 1.0;
